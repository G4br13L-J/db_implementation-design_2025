--Primero: Inicia.bat  luego:
--start hr.sql

--NO ES RECURSIVO, solo de correr una vez... en caso 
--de querer volver a correr, deben correr script "RENICIAR"  Inicia.bat 

-- así es como debería lucir "mas o menos" con algunos ajustes "a mi gusto"
-- un SCRIPT completo para crear el modelo relacional y demás elementos (alguna lógica de negocios)
-- de un "SISTEMA COMPLETO ESPECIFICO"


--OJO* spool genera toda la salida en pantalla y en un archivo //al final colocar spool off
spool hr.log
PROMPT ====================================================================
PROMPT En Oracle 9,10 y 11 había un usuario "hr" con unas tablas para ejemplo de un sistema de recursos humanos
PROMPT hr ( human resources )
--vamos a crearlo como bases1 (para lo cual, ANTES hay que correr script de REINICIAR, para borrar todas las tablas) 
--que borra todos los objetos de usuario "bases1"

--conectamos con bases1 y la clave que todos tenemos igual
conn bases1/bases123


PROMPT ====================================================================
PROMPT Create the REGIONS table to hold region information for locations
PROMPT  LOCATIONS table has a foreign key to this table.
...
--OJO* forma de crear PK en dos pasos...
...
PROMPT ====================================================================
PROMPT Create the COUNTRIES table to hold country information for customers
PROMPT and company locations. 
PROMPT OE.CUSTOMERS table and  LOCATIONS have a foreign key to this table.
...
PROMPT ====================================================================
PROMPT Create the LOCATIONS table to hold address information for company departments.
PROMPT  DEPARTMENTS has a foreign key to this table.
...
PROMPT Useful for any subsequent addition of rows to locations table
PROMPT Starts with 3300
CREATE SEQUENCE locations_seq
   ...
   NOCYCLE;
PROMPT ====================================================================
PROMPT Create the DEPARTMENTS table to hold company department information.
PROMPT  EMPLOYEES and  JOB_HISTORY have a foreign key to this table.
...
PROMPT Useful for any subsequent addition of rows to departments table
PROMPT Starts with 280 
CREATE SEQUENCE departments_seq
   ...
   NOCYCLE;
PROMPT ====================================================================
PROMPT Create the JOBS table to hold the different names of job roles within the company.
PROMPT  EMPLOYEES has a foreign key to this table.
...
PROMPT ====================================================================
PROMPT Create the EMPLOYEES table to hold the employee personnel 
PROMPT information for the company.
PROMPT  EMPLOYEES has a self referencing foreign key to this table.

--OJO* que puedo ponerle un nombre de CONSTRAINT a los campos NOT NULL (pero usualmente no se hila tan fino)
...
PROMPT Useful for any subsequent addition of rows to employees table
PROMPT Starts with 207 
...
CREATE SEQUENCE employees_seq
   ...
   NOCYCLE;
PROMPT ====================================================================
PROMPT Create the JOB_HISTORY table to hold the history of jobs that 
PROMPT employees have held in the past.
PROMPT  JOBS, HR_DEPARTMENTS, and  EMPLOYEES have a foreign key to this table.
...
PROMPT ====================================================================
PROMPT Create the EMP_DETAILS_VIEW that joins the employees, jobs, 
PROMPT departments, jobs, countries, and locations table to provide details
PROMPT about employees.
...
PROMPT ===========================insert data into the REGIONS table
...
--OJO* otra forma de insertar.. deshabilito FK
PROMPT ===========================*insert data into the DEPARTMENTS table
PROMPT disable integrity constraint to EMPLOYEES to load data
ALTER TABLE departments 
...
PROMPT ===========================insert data into the JOBS table
...
PROMPT ===========================insert data into the EMPLOYEES table
...
PROMPT ========= insert data into the JOB_HISTORY table
...
PROMPT enable integrity constraint to DEPARTMENTS
ALTER TABLE departments 
   ENABLE CONSTRAINT dept_mgr_fk;
COMMIT;

--OJO* indices los vemos en BASES2
...
--OJO* una regla de negocios en PROCEDIMIENTOS (los vemos luego)
PROMPT procedure and statement trigger to allow dmls during business hours:
...
PROMPT ==========================================================================
PROMPT procedure to add a row to the JOB_HISTORY table and row trigger 
PROMPT to call the procedure when data is updated in the job_id or 
PROMPT department_id columns in the EMPLOYEES table:
